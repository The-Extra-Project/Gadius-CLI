"""
this script is adapter for migrating the shape files from the given sample database to output.
...
class LidarHdFilesMigration():
    ...
    def migrate_datasets(self):
        ...
        ## for other small tiles, given that there is no better way to migrate  them automatically.
